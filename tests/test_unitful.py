...
#     unit_sqrt_m = Unit(scale=0, dim={SI.m: IntFraction(1, 2)})
...
#     unit_cube_root_m = Unit(scale=0, dim={SI.m: IntFraction(1, 3)})
#     unit_two_thirds_m = Unit(scale=0, dim={SI.m: IntFraction(2, 3)})
...
#     unit_pos_frac = Unit(scale=0, dim={SI.s: IntFraction(3, 4)})
#     unit_neg_frac = Unit(scale=0, dim={SI.s: IntFraction(-3, 4)})
...
#     unit_frac_kg = Unit(scale=0, dim={SI.kg: IntFraction(2, 5)})
...
#     assert result.unit.dim == {SI.kg: IntFraction(2, 5)}
...
#     unit_frac_A = Unit(scale=0, dim={SI.A: IntFraction(7, 11)})
...
#     assert u1.unit.dim == {SI.A: IntFraction(7, 11)}
#     assert u2.unit.dim == {SI.A: IntFraction(7, 11)}
...
#     sqrt_unit = Unit(scale=0, dim={SI.m: IntFraction(1, 2)})
...
#     assert result.unit.dim == {SI.m: IntFraction(3, 2)}
...
#     complex_unit = Unit(scale=2, dim={SI.m: IntFraction(3, 2), SI.kg: IntFraction(-1, 3)})
...
#         assert item.unit.dim == {SI.m: IntFraction(3, 2), SI.kg: IntFraction(-1, 3)}
...
#     fractional_unit = Unit(scale=0, dim={SI.m: IntFraction(2, 3)})
...
#     frac_unit = Unit(scale=0, dim={SI.m: IntFraction(1, 2)})
...
#     fractional_unit = Unit(scale=0, dim={SI.kg: IntFraction(3, 4)})
...
#     assert jnp.allclose(result.value(), expected)
#     assert result.unit.dim == {SI.kg: IntFraction(3, 4)}
...
#     complex_unit = Unit(scale=-2, dim={SI.m: IntFraction(5, 3), SI.kg: IntFraction(-2, 7), SI.s: IntFraction(1, 2)})
...
#     assert result.unit.dim == {SI.m: IntFraction(5, 3), SI.kg: IntFraction(-2, 7), SI.s: IntFraction(1, 2)}
...
#     fractional_unit = Unit(scale=0, dim={SI.m: IntFraction(3, 2)})
...
#     complex_unit = Unit(scale=-1, dim={SI.kg: IntFraction(-2, 3), SI.m: IntFraction(4, 5), SI.s: -1})
...
#     assert result.unit.dim == {SI.kg: IntFraction(-2, 3), SI.m: IntFraction(4, 5), SI.s: -1}
...
#     complex_unit = Unit(scale=-2, dim={SI.m: IntFraction(5, 4), SI.kg: IntFraction(-1, 2), SI.s: IntFraction(3, 7)})
...
#     assert result.unit.dim == {SI.m: IntFraction(5, 4), SI.kg: IntFraction(-1, 2), SI.s: IntFraction(3, 7)}
...
#     fractional_unit = Unit(scale=2, dim={SI.m: IntFraction(3, 2), SI.kg: IntFraction(-1, 4)})
...
#     complex_unit = Unit(scale=-1, dim={SI.kg: IntFraction(2, 3), SI.m: IntFraction(-5, 7), SI.s: IntFraction(4, 9)})
...
#     # 5D array
#     exotic_unit = Unit(scale=-12, dim={SI.kg: IntFraction(1, 3), SI.cd: IntFraction(-2, 5)})
...
#     complex_unit = Unit(
#         scale=7,
#         dim={SI.kg: IntFraction(-3, 4), SI.m: IntFraction(5, 6), SI.s: -2, SI.A: IntFraction(1, 7), SI.K: IntFraction(-2, 9)},
#     )
...
#     fractional_unit = Unit(scale=-2, dim={SI.kg: IntFraction(2, 3), SI.m: IntFraction(-1, 2), SI.s: IntFraction(3, 4)})
...
#     assert jnp.allclose(result.value(), expected_values)
#     assert result.unit.dim == {SI.kg: IntFraction(2, 3), SI.m: IntFraction(-1, 2), SI.s: IntFraction(3, 4)}
